  ...
  <body class="c-app">
    <div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
      ...
      <ul class="c-sidebar-nav">
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link" href="getting-started.php"><div class="c-sidebar-nav-icon"><span class="icon-getting-started"></span></div> Getting Started</a>          
        </li> 
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link" href="./"><div class="c-sidebar-nav-icon"><span class="icon-dashboard"></span></div> Dashboard</a>          
        </li> 
        <li class="c-sidebar-nav-item">
    ...
    <div class="c-wrapper c-fixed-components">
      <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
         <div class="m-top d-lg-none">
          <ul class="c-header-nav">         
            <li class="c-header-nav-item px-2"><a class="c-header-nav-link" href="lead-add.php">Contact</a></li>
            <li class="c-header-nav-item px-2"><a class="c-header-nav-link" href="task.php">Task</a></li>
            <li class="c-header-nav-item px-2">
            <a class="c-header-nav-link search-link" href="#">
                <div class="c-icon">
                    <span class="icon-magnifying-glass"></span>
                </div>
            </a>
            </li>
            <li class="ml-auto c-header-nav-item px-2">
                <a class="c-header-nav-link" href="#">
                  <div class="c-icon svf"><span class="icon-global"></span></div>
                  <span class="badge badge-success inline">0</span>
                </a>
            </li>
          </ul>
         </div>
        <button class="c-header-toggler c-class-toggler d-lg-none" type="button" data-target="#sidebar" data-class="c-sidebar-show">
          <svg class="c-icon c-icon-lg">
            <use xlink:href="images-leadhero/free.svg#cil-menu"></use>
          </svg>
        </button>
        ...
        <ul class="c-header-nav ml-auto mr-2 mr-lg-4">
          <li class="c-header-nav-item d-md-down-none mx-2">
            <a class="c-header-nav-link" href="#">
              <div class="c-icon mr-2"><span class="icon-global"></span></div> Site Visit Follow Up
              <span class="badge badge-success inline">0</span>
            </a>
          </li>
          <li class="c-header-nav-item mx-2">
            <a class="c-header-nav-link" alt="Help" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
              <div class="c-icon">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg pt-0">
                ...
                <a class="dropdown-item" href="#">
                    <div class="c-icon mr-2"><span class="icon-thought"></span></div> Knowledge Base
                </a> 
            </div>
          </li>
          ...
          <li class="c-header-nav-item dropdown"><a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
              <div class="c-avatar"><img class="c-avatar-img" src="images-leadhero/avatars/no-img.jpg" title="Vianaar Homes"></div>
            </a>
            <div class="dropdown-menu dropdown-menu-right pt-0">
              <div class="dropdown-header bg-light py-2"><strong>Vianaar Homes</strong></div>
        ...
        <div class="c-subheader px-3">
          ...
          <ol class="breadcrumb border-0 m-0">
           ...
           <div class="c-subheader-nav ml-auto mfe-2">
            <a class="c-subheader-nav-link c-class-toggler" href="#" data-target="#aside" data-class="c-sidebar-show">
                <svg class="c-icon">
                  <use xlink:href="images-leadhero/free.svg#cil-applications-settings"></use>
                </svg> &nbsp; Filter by Tags
            </a>
          </div>
